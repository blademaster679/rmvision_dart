...
#define NODE_MAIN_LOGGER_NAME "video_reader_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libvideo_reader.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<video_reader::VideoReaderNode>";
