...
#define NODE_MAIN_LOGGER_NAME "light_detector_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "liblight_detector.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<rm_auto_aim_dart::LightDetectorNode>";
