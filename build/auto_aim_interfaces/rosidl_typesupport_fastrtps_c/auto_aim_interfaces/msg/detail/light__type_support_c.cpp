...
#include "auto_aim_interfaces/msg/detail/light__rosidl_typesupport_fastrtps_c.h"
...
using _Light__ros_msg_type = auto_aim_interfaces__msg__Light;
...
size_t get_serialized_size_auto_aim_interfaces__msg__Light(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Light__ros_msg_type * ros_message = static_cast<const _Light__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Light__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_auto_aim_interfaces__msg__Light(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_auto_aim_interfaces
size_t max_serialized_size_auto_aim_interfaces__msg__Light(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = auto_aim_interfaces__msg__Light;
    is_plain =
      (
...
static size_t _Light__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_auto_aim_interfaces__msg__Light(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, auto_aim_interfaces, msg, Light)() {
