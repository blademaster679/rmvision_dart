...
#include "auto_aim_interfaces/msg/detail/lights__rosidl_typesupport_fastrtps_c.h"
...
#include "auto_aim_interfaces/msg/detail/light__functions.h"  // lights
...
using _Lights__ros_msg_type = auto_aim_interfaces__msg__Lights;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: lights
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, auto_aim_interfaces, msg, Light
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: lights
  {
    ...
    if (ros_message->lights.data) {
      auto_aim_interfaces__msg__Light__Sequence__fini(&ros_message->lights);
    }
  ...
  size_t current_alignment)
{
  ...
  // field.name lights
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_auto_aim_interfaces__msg__Light(
...
static uint32_t _Lights__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_auto_aim_interfaces__msg__Lights(
  ...
  size_t current_alignment)
{
  ...
  // member: lights
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_auto_aim_interfaces__msg__Light(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = auto_aim_interfaces__msg__Lights;
    is_plain =
      (
...
static size_t _Lights__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_auto_aim_interfaces__msg__Lights(
