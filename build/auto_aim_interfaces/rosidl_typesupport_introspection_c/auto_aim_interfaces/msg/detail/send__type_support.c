...
static rosidl_typesupport_introspection_c__MessageMember auto_aim_interfaces__msg__Send__rosidl_typesupport_introspection_c__Send_message_member_array[3] = {
  {
    "header",  // name
