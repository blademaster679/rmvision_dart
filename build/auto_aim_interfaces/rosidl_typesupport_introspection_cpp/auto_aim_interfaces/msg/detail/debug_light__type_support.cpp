...
static const ::rosidl_typesupport_introspection_cpp::MessageMember DebugLight_message_member_array[3] = {
  {
    "center_x",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(auto_aim_interfaces::msg::DebugLight, radius),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
