...
static_assert(
    offsetof(SendPacket, lateral_distance) == 13, "SendPacket lateral distance offset mismatch");
static_assert(
    offsetof(SendPacket, dart_id_change_flag) == 17, "SendPacket dart flag offset mismatch");
